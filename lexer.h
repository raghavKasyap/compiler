...
TokenInfo *insertEntry(Symbol_Table_Record **Symbol_Table, char *lexeme, int linenum, Value *value, int token_id);
Symbol_Table_Record *lookup(Symbol_Table_Record **Symbol_Table, char *lexeme);
int hash_function(char *string);
TokenInfo *createToken(char *lexeme, int linenum, Value *val, int token_id, bool isError);
